...
class ERC1155Factory
{
    ...
    public function make(Ethereum $chain, AddressInterface $address = null, array $event = null): ERC1155
    {
        ...
        if ($address && !$this->ERC1155->getContractAddress()->compare($address->toString())) {
